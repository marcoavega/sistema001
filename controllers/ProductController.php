...
class ProductController
{
    ...
    {
        $this->productModel = new Product(); // Se crea una instancia del modelo `User`.
    }
  ...
  public function getAllProducts()
{
    ...
    try {
        ...
        // Registrar/loguear el error y devolver un array vacío o lanzar excepción según convenga
