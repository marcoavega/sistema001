...
document.addEventListener("DOMContentLoaded", function () {
  // Busca el elemento HTML con el ID "produts-table" y lo almacena en la variable produtsTableElement.
  var productsTableElement = document.getElementById("products-table");

  // Si no existe el elemento con ID "produts-table" en el documento, termina la ejecución de la función.
  ...
  var table = new Tabulator("#products-table", {
    ...
    columns: [
      // Columna para el ID de usuario.
      {
        ...
        field: "product_id", // Nombre del campo en los datos JSON que corresponde a esta columna.
        width: 100, // Ancho de la columna en píxeles.
      ...
      // Columna para el nombre de usuario.
      {
        ...
        field: "product_code", // Nombre del campo en los datos JSON.
